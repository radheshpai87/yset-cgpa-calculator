      ...
      <section className="py-16 border-t border-neutral-100 dark:border-neutral-800">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4">
            YSET GPA Calculator for Yenepoya Engineering Students
          </h2>
          <div className="prose prose-neutral dark:prose-invert max-w-3xl text-neutral-600 dark:text-neutral-400 space-y-3 text-sm">
            <p>
